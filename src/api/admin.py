...
from .models import db, User, Diner, Origin, Owner, Restaurant, Categories, RestaurantCategories, Reservation
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(RestaurantCategories, db.session))
