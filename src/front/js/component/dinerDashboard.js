...
//                                 </ul>
//                                 <button 
//                                 type="button" onClick={() => navigate("/giftcard")} className="w-100 btn btn-lg btn-outline-primary">Quiero mi Gift Card</button>
//                             </div>
//                         </div>
//                     </div>
//                     </div>
//                     <div className="container mt-5 d-flex justify-content-between mb-2">
                    ...
                    {activeTab === "restaurantes" && (
                        <div className="container mt-4">
                            <div className="row g-4">
                                ...
                                {store.restaurants && store.restaurants.length > 0 ? (
                                    store.restaurants.map((restaurant, index) => {
                                        const stars = Math.floor(Math.random() * 3) + 1; // Genera un numero entre 1 y 3
                                                ...
                                                <div className="card card-img-scale overflow-hidden bg-transparent">
                                                    ...
                                                    <div className="card-body px-2">
                                                        ...
                                                        <div className="d-flex justify-content-between">
                                                            <h5>cocina {restaurant.cuisine_type}</h5>
                                                            <h5>{restaurant.average_price}</h5>
                                                        </div>
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <h6 className="text-success mb-0">
                                                                <small className="fw-light">Capacidad {restaurant.capacity} Personas</small>
                    ...
                    <div className="container">
                        <div className="col-md-4 mb-4">
                            <div className="card mb-4 rounded-3 shadow-sm hover-effect">
                                ...
                                <div className="card-body">
                                    <h1 className="card-title pricing-card-title">$0<small className="text-body-warning fw-light">/mo</small></h1>
                                    <ul className="list-unstyled mt-3 mb-4">
                                        <li>La primera gift card va por nuestra cuenta al utilizar nuestra app!</li>
                                        <li>Puedes redimir tu tarjeta hasta en un año.</li>
                                        <li>Redímelas en cualquier restaurante RestauraPP de España!</li>
                                        <li>Sortearemos mensualmente gift cards entre nuestros usuarios!</li>
                                    </ul>
                                    <button
                                        type="button" onClick={() => navigate("/giftcard")} className="w-100 btn btn-lg btn-outline-warning">Quiero mi Gift Card</button>
                                </div>
                            </div>
                        </div>
                    </div>
